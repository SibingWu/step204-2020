...
const CREATE_APPLICANT_PAGE = './applicant/index.html';
const CREATE_BUSINESS_PAGE = './business/index.html';
...
applicantButton.addEventListener('click', (_) => {
  window.location.href = CREATE_APPLICANT_PAGE;
});

const businessButton = document.getElementById('business-log-in');
businessButton.addEventListener('click', (_) => {
  window.location.href = CREATE_BUSINESS_PAGE;
});
